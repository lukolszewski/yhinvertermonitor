...
def send_autodiscovery(device,discovery_prefix,mqtt_broker,mqtt_port):
    try:

        device_info = device.get('autodiscovery', {}).get('device', {})
        ...
        extra_entities = device.get('autodiscovery', {}).get('extra', {})
...
def clear_autodiscovery(device,discovery_prefix,mqtt_broker,mqtt_port):
    try:
